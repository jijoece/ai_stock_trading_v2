...
| Migration orchestration automation (state machine, quota handling, cost controls) | [`library-migration/AUTOMATION.md`](library-migration/AUTOMATION.md) | Canonical for the automation layer only; it is subordinate to `MASTER_PLAN.md` and `STATUS.md`, which decide what each phase contains |
